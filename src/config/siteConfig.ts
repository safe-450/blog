...
export const siteConfig: SiteConfig = {
	title: "450Safe的小站",
	subtitle: "欢迎来到我的小站！",
	siteURL: "https://450safe.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "385597490", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	imageOptimization: {
		...
		noReferrerDomains: [
			...
			"*.giteeusercontent.com", // Gitee Raw
			"*.gitcode.com", // GitCode Raw
			],
	},
};
